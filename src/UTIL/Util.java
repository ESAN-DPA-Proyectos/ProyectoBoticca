...
public class Util {
    ...
    public String obtenerFecha(){
       ...
       try{
        ...
        public static String validaCorreoYTabla(String email, boolean isEmpty){
            String mensaje = "";
            if(email.isEmpty()){
                mensaje += "Debe colocar un email para enviar el PDF";
            }

            if(isEmpty){
                mensaje += "\nNo hay datos para construir el PDF";
            }
